...
public  class CulturalItemAdapter extends RecyclerView.Adapter<ItemHolder> implements Filterable {
    ...
    public CulturalItemAdapter(Context context, List<Item> lista){
super();
        this.lista=lista;
