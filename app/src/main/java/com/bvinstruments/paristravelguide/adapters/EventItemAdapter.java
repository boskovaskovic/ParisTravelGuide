...
public  class EventItemAdapter extends RecyclerView.Adapter<ItemHolder> implements Filterable {
    ...
    public EventItemAdapter(Context context, List<Item> lista){
super();
        this.lista=lista;
