...
public  class HotelItemAdapter extends RecyclerView.Adapter<ItemHolder> implements Filterable {
    ...
    public HotelItemAdapter(Context context, List<Item> lista){
super();
        this.lista=lista;
